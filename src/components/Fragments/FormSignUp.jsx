...
const SignUpSchema = Yup.object().shape({
  name: Yup.string().min(3, "Nama minimal 3 karakter").required("Name wajib diisi"),
      ...
      <div className="mt-16">
        <Formik
          ...
          onSubmit={async (values, { setSubmitting }) => {
            try {
              // Menjalankan fungsi submit yang dilempar dari parent
              if (onSubmit) {
        ...
        >
          {({ isSubmitting }) => (
            <Form>
              ...
              <div className="mb-3">
                <p className="text-xs text-gray-03 my-4">
